...
Welcome to your first Go program! This tutorial will guide you through writing, running, and understanding your first Go program.
...
[**Go 语言基础概念**](/golang/fundamentals/overview/) - 系统学习 Go 的核心基础

<div class="kb-card-grid">
  <a class="kb-card" href="/golang/fundamentals/naming-conventions">
    <span class="kb-card-title">命名规则</span>
    <span class="kb-card-desc">驼峰命名、可见性规则</span>
  </a>
  <a class="kb-card" href="/golang/fundamentals/variables-constants">
    <span class="kb-card-title">声明与初始化</span>
    <span class="kb-card-desc">变量、常量、零值机制</span>
  </a>
  <a class="kb-card" href="/golang/fundamentals/type-system">
    <span class="kb-card-title">类型系统</span>
    <span class="kb-card-desc">基础类型、复合类型</span>
  </a>
  <a class="kb-card" href="/golang/fundamentals/functions-methods">
    <span class="kb-card-title">函数与方法</span>
    <span class="kb-card-desc">函数、闭包、defer</span>
  </a>
  <a class="kb-card" href="/golang/fundamentals/package-system">
    <span class="kb-card-title">包系统</span>
    <span class="kb-card-desc">导入、依赖管理</span>
  </a>
  <a class="kb-card" href="/golang/fundamentals/variable-lifecycle">
