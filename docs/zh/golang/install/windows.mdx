...
<Tabs groupId="install-method">
  <TabItem value="msi" label={<><Badge text="MSI 图形化" type="tip" /> <span style={{ fontSize: '14px' }}>推荐新手</span></>}>
  ...
  <TabItem value="choco" label={<><Badge text="Chocolatey" type="info" /> <span style={{ fontSize: '14px' }}>命令行</span></>}>
    <div style={{ marginTop: '16px' }}>
  ...
  <TabItem value="scoop" label={<><Badge text="Scoop" type="info" /> <span style={{ fontSize: '14px' }}>无需管理员</span></>}>
    <div style={{ marginTop: '16px' }}>
  ...
  <TabItem value="zip" label={<><Badge text="ZIP 便携版" type="warning" outline /> <span style={{ fontSize: '14px' }}>高级</span></>}>
    <div style={{ marginTop: '16px' }}>
