...
<Tabs groupId="install-method">
  <Tab value="msi" label={<><Badge text="MSI 图形化" type="tip" /> <span style={{ fontSize: '14px' }}>推荐新手</span></>}>
    <div style={{ marginTop: '16px' }}>

      **适合人群**：第一次安装软件，希望使用图形界面

      <Badge text="预计时间" type="info" /> 2-3分钟
      <Badge text="权限要求" type="warning" /> 管理员权限
  ...
  <Tab value="choco" label={<><Badge text="Chocolatey" type="info" /> <span style={{ fontSize: '14px' }}>命令行</span></>}>
    <div style={{ marginTop: '16px' }}>
  ...
  <Tab value="scoop" label={<><Badge text="Scoop" type="info" /> <span style={{ fontSize: '14px' }}>无需管理员</span></>}>
    <div style={{ marginTop: '16px' }}>

      **适合人群**：希望安装到用户目录，不需要管理员权限

      <Badge text="预计时间" type="info" /> 2-3分钟
      <Badge text="权限要求" type="tip" /> 无需管理员
  ...
  <Tab value="zip" label={<><Badge text="ZIP 便携版" type="warning" outline /> <span style={{ fontSize: '14px' }}>高级</span></>}>
    <div style={{ marginTop: '16px' }}>

      **适合人群**：需要自定义安装路径或多版本共存

      <Badge text="预计时间" type="info" /> 3-5分钟
      <Badge text="权限要求" type="tip" /> 无需管理员（用户目录）
