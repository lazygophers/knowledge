...
flowchart TD
    ...
    classDef globalScope fill:#e3f2fd,stroke:#1976d2,color:#0d47a1
    classDef functionScope fill:#bbdefb,stroke:#1976d2,color:#0d47a1
    classDef blockScope fill:#90caf9,stroke:#1976d2,color:#0d47a1
    classDef nestedScope fill:#64b5f6,stroke:#1565c0,color:#ffffff
...
flowchart TD
    ...
    linkStyle default stroke:#3b82f6,stroke-width:2px
    classDef stackAlloc fill:#c8e6c9,stroke:#2e7d32,color:#064e3b
    classDef heapAlloc fill:#ffcdd2,stroke:#d32f2f,color:#7f0000
    classDef cleanup fill:#a5d6a7,stroke:#065f46,color:#ffffff
    classDef gcCollect fill:#ef9a9a,stroke:#dc2626,color:#ffffff
