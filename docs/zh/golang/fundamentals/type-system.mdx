...
flowchart TD
    ...
    classDef basic fill:#bbdefb,stroke:#1976d2,color:#0d47a1
    classDef composite fill:#fff7ed,stroke:#f59e0b,color:#78350f
    classDef reference fill:#f3e5f5,stroke:#7c3aed,color:#4c1d95
    classDef custom fill:#e8f5e9,stroke:#059669,color:#064e3b
