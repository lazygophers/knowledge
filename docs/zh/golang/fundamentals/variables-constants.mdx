...
flowchart TD
    ...
    classDef mustVar fill:#ffcdd2,stroke:#d32f2f,color:#7f0000
    classDef shortDecl fill:#c8e6c9,stroke:#2e7d32,color:#064e3b
    classDef typeInf fill:#e1f5ff,stroke:#1976d2,color:#0d47a1
    classDef varDecl fill:#fff9c4,stroke:#f59e0b,color:#78350f
```
