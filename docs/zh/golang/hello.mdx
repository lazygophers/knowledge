...
<Tabs groupId="concept-level">
  <Tab value="basic" label={<><Badge text="基础概念" type="tip" /> <span style={{ fontSize: '14px' }}>必读</span></>}>
  ...
  <Tab value="advanced" label={<><Badge text="进阶知识" type="info" /> <span style={{ fontSize: '14px' }}>扩展</span></>}>
    <div style={{ marginTop: '16px' }}>
  ...
  <Tab value="expert" label={<><Badge text="深入理解" type="warning" outline /> <span style={{ fontSize: '14px' }}>高级</span></>}>
    <div style={{ marginTop: '16px' }}>
...
<Tabs groupId="user-level">
  <Tab value="beginner" label={<><Badge text="无技术背景" type="tip" /> <span style={{ fontSize: '14px' }}>详细讲解</span></>}>
    <div style={{ marginTop: '16px' }}>
  ...
  <Tab value="developer" label={<><Badge text="初级开发者" type="info" /> <span style={{ fontSize: '14px' }}>常见错误</span></>}>
    <div style={{ marginTop: '16px' }}>
  ...
  <Tab value="intermediate" label={<><Badge text="中级开发者" type="warning" /> <span style={{ fontSize: '14px' }}>Go Modules</span></>}>
    <div style={{ marginTop: '16px' }}>
  ...
  <Tab value="advanced" label={<><Badge text="高级开发者" type="warning" outline /> <span style={{ fontSize: '14px' }}>性能优化</span></>}>
    <div style={{ marginTop: '16px' }}>
  ...
  <Tab value="enterprise" label={<><Badge text="专业开发者" type="danger" /> <span style={{ fontSize: '14px' }}>最佳实践</span></>}>
    <div style={{ marginTop: '16px' }}>
